...
class FormTemplate {
  ...
  static Widget buildDateInput(TextEditingController controller, String caption, IconData icon, int labelColor, int borderColor, int borderFocusColor, String heroTag){
    return new Padding(
      padding: EdgeInsets.only(left: 8.0, bottom: 5.0, top: 5.0, right: 8.0),
      child: new Row(
        children: <Widget>[
